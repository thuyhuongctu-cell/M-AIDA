...
| Bản | Tệp | Thời lượng |
|---|---|--:|
| Remix 1 | `assets/maida_song_la_recherche_remix1.mp3` | 4:49 |
| Remix 2 | `assets/maida_song_la_recherche_remix2.mp3` | 4:49 |

Hai bản ghi có cùng độ dài đến từng mili giây (289,728 s) nhưng khác dữ liệu và
khác bitrate (183 kbps so với 186 kbps), tức là hai lần kết xuất của cùng một
bản phối chứ không phải hai bản dựng khác nhau. Vì vậy chúng được xếp là
"remix 1" và "remix 2" thay vì "bản gốc" và "remix": kho nhạc hiện chưa có bản
gốc của bài này.
...
trong lần cập nhật này; hai bản ghi đã phát được bình thường trong danh sách và
